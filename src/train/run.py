...
try:
    import comet_ml
    from comet_ml import Experiment as _CometExperiment
except Exception:
    comet_ml = None
    _CometExperiment = None
class DummyExperiment:
    ...
    def train(self): return self._Ctx()
    def test(self): return self._Ctx()
Experiment = _CometExperiment if (os.environ.get('COMET_DISABLE') not in ('1','true','True') and os.environ.get('COMET_API_KEY') and _CometExperiment is not None) else DummyExperiment
